...
# очищаем таблицу Resistors
cur_dst.execute("DELETE FROM Resistors;")
conn_dst.commit()

insert_sql = """
INSERT INTO Resistors
  ([Part Number],[Description],[Library Ref],[Footprint Ref],
   [Library Path],[Footprint Path],[Package],[Resistance],[Tolerance],[Comment])
VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
"""
